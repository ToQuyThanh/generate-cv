...
import { FileText, LayoutDashboard, Settings, LogOut, CreditCard, Sparkles, PlusCircle } from 'lucide-react'
    ...
    <aside className="flex h-screen w-64 flex-col border-r bg-card">
      ...
      <nav className="flex-1 space-y-1 p-4">
        {navItems.map(({ href, label, icon: Icon }) => {
          // /cv/new active khi đang ở /cv/new hoặc /templates (redirect)
          const isActive =
            pathname === href ||
